"""
Django settings for e-Market project.
...
ALLOWED_HOSTS = ['edo-market-app.herokuapp.com', 'localhost', '127.0.0.1']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'opq@gmail.com' # this email will be used to send emails
